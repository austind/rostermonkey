...
IF "%LOGFILE%"=="" SET LOGFILE=.\logs\Students.log
IF "%FINAL%"=="" SET FINAL=.\patdata\Students.xml
IF "%PATRON_PROP%"=="" SET PATRON_PROP=.\config\map_students.properties
IF "%UPDATE%"=="" SET UPDATE=.\config\update_students.properties
